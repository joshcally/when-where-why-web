  ...
  return (
    <div className="about">
      <Container className="p-3">
        <h1>About</h1>
        <Col xs={6} md={4}>
          <Image width="100%" src={profile} rounded/>
        </Col>
        ...
        <Col xs={6} md={4}>
          <a className="bees-keys-icon" href="https://apps.apple.com/us/app/bees-keys-first-piano-lesson/id1608004053?itscg=30200&amp;itsct=apps_box_appicon">
            <Image rounded width="100%" src="https://is1-ssl.mzstatic.com/image/thumb/Purple126/v4/e0/11/99/e01199a0-8283-aa01-47a3-5cc1654d6c48/AppIcon-0-1x_U007emarketing-0-7-0-85-220.png/540x540bb.jpg" alt="Bees Keys - First Piano Lesson" />
          </a>
        </Col>
        <br/>
